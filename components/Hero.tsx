  ...
  return (
    <section className=''>
      <div className="relative group z-20 flex flex-1 flex-col">
        ...
        <div className="absolute bottom-3 xs:bottom-7 right-0 left-0">
        ...
        <div className="absolute w-[759px] h-[294px] gap-2 -translate-x-0 translate-y-[5%] xs:translate-y-[15%] sm:translate-y-[35%] md:translate-y-[45%] left-[6%] lg:left-[110px] md:left-[6%]">
          <h1 className='text-white bold-14 xs:bold-18 md:bold-20 lg:bold-30'>Discover Your Next Adventure</h1>
